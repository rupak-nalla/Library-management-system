...
async function fetchBook(bookId) {
     ...
     const res= await fetch(`http://localhost:8080/api/getBook/${bookId}`,{
          method:"GET",
          headers: {
...
async function HandleSubmit() {
     ...
     formData.append('Bid',route.params.Bid)
     ...
     <div id="main" class="row" style="color: white;">
          ...
          <div class="col">
               <div class="row" style="color: white;">
                    ...
                    <h4>Book Name</h4>
                    <div class="mb-3">
                         <input type="text" id="BookName" aria-describedby="helpId" class="form-control" style="width:250px;" :value="bookData['Name']"  placeholder="Book Name" required>
                    </div>
                    <br>
                    <h4>Author Name</h4>
                    <div class="mb-3">
                         <input type="text"  aria-describedby="helpId" class="form-control" style="width:250px;" id="AuthorName" :value="bookData['AuthorName']"  placeholder="Author Name" required>
                    </div>
                    <h4>Content</h4>
                    <div class="mb-3">
                         <input type="text"  aria-describedby="helpId" class="form-control" style="width:250px;" id="Content" :value="bookData['Content']" placeholder="Content" required>
                    </div>
                    <div class="mb-3">

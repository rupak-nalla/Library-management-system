...
<template>
     <div id="main" class="row">
          ...
          <div class="col">
               <h3 style="color: white;">Create Section</h3>
               ...
               <div class="row" v-for="i in  booksData.length">
                         ...
                         <div class="col">
                              <div v-if="booksData[i-1][1]" class="card mb-3" style="max-width: 540px;">
                                   <div class="row g-0">
                                        <div class="col-md-4">
                                             <img src="../assets/book-cover.jpg" class="img-fluid rounded-start" alt="...">
                                        </div>
                                        <div class="col-md-8">
                                             <div class="card-body">
                                                  ...
                                                  <div>
                                                       <div class="form-check">
                                                            <input class="form-check-input" name="option" type="checkbox" :value="booksData[i-1][1].Bid" id="bookSelected">
